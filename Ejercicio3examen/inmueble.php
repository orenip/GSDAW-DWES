 ...
 *	La clase "inmueble.class.php" es la clase del modelo, que representa a un jugador de la tabla
 */
require_once 'src/response.php';
require_once 'src/classes/auth.class.php';
require_once 'src/classes/inmueble.class.php';
...
switch ($_SERVER['REQUEST_METHOD']) {
	...
	case 'POST':
		...
		$insert_id = $inmueble->insert($params);
	...
	case 'PUT':
		...
		$inmueble->updatePut($_GET['id'], $params);
	...
	case 'PATCH':
		...
		$inmueble->updatePatch($_GET['id'], $params);
