...
<body>
	...
	<form action="index.php" method="post">
		...
		<input type="text" name="cod_profesor" value="<?php echo $profesor->getCodProfesor(); ?>" readonly>
		</br>

		<?php echo isset($errores["nombre_profesor"]) ? "*" : "" ?>
		<label for="nombre_profesor">Nombre profesor</label>
		<input type="text" name="nombre_profesor" value="<?php echo $profesor->getNombreProfesor(); ?>">
		</br>
